            ...
            class r extends s.b {
                ...
                onInit() {
                    ...
                    this.p5 = new n((function (e) {
                        ...
                        function d(t, i, s) {
                            let o = t % e.TWO_PI;
                            return o < 0 && (o += e.TWO_PI), e.noise(u + e.cos(o) * i, c + e.sin(o) * i, l + s)
                        }
                        e.setup = function () {
                            t.initP5(e), e.strokeWeight(1), e.stroke(Object(o.a)(t.options.color)), e.smooth(), e.noFill()
                        }, e.draw = function () {
                            e.clear(), e.translate(e.width / 2, e.height / 2),
                                function () {
                                    ...
                                    for (let o = 0; o < i; o++) {
                                        ...
                                        for (let i = 0; i < 360; i++) {
                                            let u = e.radians(i),
                                                c = t.options.chaos * a * d(u, h * o + r, l) + (n * o + s) + (o * t.options.spacing || 0);
